...
{
    public function __construct(protected GrammarCorrectionService $grammarCorrectionService)
    {
    }
    ...
    public function store(Request $request)
    {
        ...
        $result = $this->grammarCorrectionService->correct($inputText, $sourceType, $pdfPageCount);
    ...
    {
        if (($report['mode'] ?? 'single') === 'single') {
            return $report['corrected_sentence'];
        }
